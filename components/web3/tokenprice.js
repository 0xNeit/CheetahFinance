import { pancakeSwapAbi } from "../../blockhain/abi/pancakeswap";
import { tokenAbi } from "../../blockhain/abi/token";
...
export const tokenPrice = async () => {
  const tokenAddres = "0xba2ae424d960c26247dd6c32edc70b295c744c43";
